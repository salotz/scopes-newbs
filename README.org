...
- [[./level_1.org][Level 2]] :: Scopes features roughly equivalent with core C/C++ or
...
- [[./level_1.org][Level 3]] :: What it means for Scopes as a "Scheme-like" language
  beyond just the syntax. The main focus here is functional
  programming and some of the basic metaprogramming features.

- [[./level_1.org][Level 4]] :: Novel Scopes features. Includes advanced metaprogramming,
